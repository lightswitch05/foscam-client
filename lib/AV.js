 ...
 * @desc Set OSD config.
 * @param {object} params
 * @param {boolean} params.isEnableTimeStamp Time stamp will display on screen or not
 * @param {boolean} params.isEnableDevName Camera name will display on screen or not
 * @param {int} params.dispPosition OSD display position, currently can only be 0
 * @param {boolean} params.isEnableOSDMask Is OSD mask effective
 * @returns {Promise<object>} A promise to the response.
 */
 ...
 *      - areaN value 2N -1(N[0-10])
 * @param {object} params
 * @param {boolean} params.isEnable Is enable motion detect alarm.
 ...
 * @param {object} params
 * @param {boolean} params.isEnableLocalAlarmRecord 0: Disable. 1: Enable.
 ...
 * @param {object} params
 * @param {boolean} params.isEnablePreRecord Preview record state
